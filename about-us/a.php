...
{
  	if(isset($_POST['user']) && isset($_POST['type']) && !empty($_POST['user']))
  {

        $ar=explode(" ",$_POST['type']);
        $BG=$ar[1];
        $hos=$ar[0];
   $query= 'INSERT INTO `userrequest`(`username`, `husername`, `bloodG`) VALUES ("'.$_POST['user'].'","'.$hos.'","'.$BG.'");';
   ...
   // $query='select * from hospital';
    if(mysqli_query($con,$query))
    {
      ...
      sleep(2);
       ...
       header('Location: http://localhost/Blood/');
    }
    else
    {
...
<!-- _____________________________________________________________________________________________________________________-->
 <div class='my' style='background:white; height:500px;'>
   <h3 style='color:black;'><strong>Search Results-: <br> </strong> </h3> 
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo $row['units']; ?></td>
             <td><button type='radio' name='selectit' value="abc " onclick="changeValue(this)" style='color:silver;'><?php echo $row['name'].' '.$BG?></button></td>
        </tr>
        <?php endwhile ?>
    </tbody>
</table>
...
<form method='POST'>
	<h2 style='color:black;'> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
   	 ...
   	 &nbsp &nbsp &nbsp &nbsp
   	 &nbsp &nbsp &nbsp &nbsp
   	  Selected Hospital: <input type="text" id="type" name="type" value="" style='font-size:20px;' />
   <h2 style='color:black;'> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
   	 &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
      ...
      <input type='submit' name='request' value='Request!' style='font-size:20px;' width="50" height="20"> </h2>
